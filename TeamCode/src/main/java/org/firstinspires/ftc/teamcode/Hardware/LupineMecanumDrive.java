...
import org.firstinspires.ftc.teamcode.Odometry.drive.TwoWheelTrackingLocalizer;
...
public class LupineMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(1.9, 0, 0);
    ...
    public LupineMecanumDrive(HardwareMap hardwareMap) {
