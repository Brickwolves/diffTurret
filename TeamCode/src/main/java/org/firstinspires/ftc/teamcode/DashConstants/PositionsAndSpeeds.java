...
public class PositionsAndSpeeds {
    public static int slidesHighJunction = 670;
    public static int slidesHighFront = 650;//9000
    public static int slidesHighFunny = 490;
    public static int slidesMidJunction = 310;  //6500
